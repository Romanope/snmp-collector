...
public class Constantes {
	...
	public static final String INTERFACE_NAME = "enp0s3";
	
	public static final String OID_IF_OUT_OCTETS = "1.3.6.1.2.1.2.2.1.16.2";
	
	public static final String OID_IF_IN_OCTETS = "1.3.6.1.2.1.2.2.1.10.1";
	
	public static final String OID_TOTAL_MEMORY_MACHINE = "1.3.6.1.4.1.2021.4.5.0";
	
	public static final String OID_TOTAL_RAM_USED = "1.3.6.1.4.1.2021.4.6.0";
	
	public static final String OID_PERCENTAGE_OF_USERCPUTIME = "1.3.6.1.4.1.2021.11.9.0";
	
	public static final String OID_USED_SPACE_ON_THE_DISK = "1.3.6.1.4.1.2021.9.1.8.1";
	
	public static final String OID_TOTAL_SIZE_OF_THE_DISK = "1.3.6.1.4.1.2021.9.1.6.1";
	
	public static final String URL_OBTER_CONFIGURACAO = "";
	
	public static final String URL_ENVIAR_DADOS_COLETADOS = "";
